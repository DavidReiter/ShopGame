...
public class GridEditor : EditorWindow
{
    ...
    [MenuItem("Window / Tools / GridEditor")]
    ...
    void Fields()
    {
        ...
        gridSize.y = Mathf.Clamp(EditorGUILayout.IntField("Height", gridSize.y), 0, 99);
    ...
    void CreateConnection()
    {
        ...
        if (tiles[0].GetComponent<Tile>() && tiles[1].GetComponent<Tile>())
        {
            ...
            Debug.Log($"Created connection between tile {tiles[0].name} and {tiles[1].name}");
        }
    }
